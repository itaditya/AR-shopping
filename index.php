    ...
    <body class="scroll">
        ...
        <div id="all">
            <div id="content">
                <div class="container">
                    <div class="col-md-12">
                        <div id="main-slider" class="swiper swipe-carousel">
                            <!-- <div class="item">
                ...
                <div id="hot">
                    ...
                    <div class="container">
                        <div class="product-slider swiper swipe-carousel">
                            <div class="item">
                                <div class="product">
                ...
                <div class="container" data-animate="fadeInUpBig">
                    <div class="col-md-12">
                        <div class="box slideshow">
                            ...
                            <div id="get-inspired" class="swiper swipe-carousel">
                                <div class="item">
                                    <a href="#">
                    ...
                    <div class="row">
                        ...
                        <div class="col-md-3 col-sm-6">
                            ...
                            <ul>
                                ...
                                <li>
                                    <a href="category.php?q=Skirts">Skirts</a>
                                </li>
                                <li>
