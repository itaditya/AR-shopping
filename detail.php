                ...
                <div class="container">
                    ...
                    <div class="col-md-9">
                        <div class="row" id="productMain">
                            <div class="col-sm-6">
                                <div id="mainImage" class="swiper swipe-product">
                            ...
                            <div class="col-sm-6">
                                ...
                                <div class="row" id="thumbs">
                                    <div class="col-xs-4">
                                        <a href="img/detailbig1.jpg" class="thumb scroll">
                                            <img src="img/detailsquare.jpg" alt="" class="img-responsive"/>
                                        </a>
                                    </div>
                                    <div class="col-xs-4">
                                        <a href="img/detailbig2.jpg" class="thumb scroll">
                                            <img src="img/detailsquare2.jpg" alt="" class="img-responsive"/>
                                        </a>
                                    </div>
                                    <div class="col-xs-4">
                                        <a href="img/detailbig3.jpg" class="thumb scroll">
