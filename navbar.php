                ...
                <div class="navbar-header">
                    ...
                    <div class="navbar-buttons">
                        ...
                        <a class="btn btn-default navbar-toggle" href="basket.html">
                            ...
                            <span class="hidden-xs">0 items in cart</span>
                        </a>
                    </div>
                </div>
                <!--/.navbar-header -->
                                    ...
                                    <div class="yamm-content">
                                        <div class="row">
                                            <div class="col-sm-3">
                                                ...
                                                <ul>
                                                    <li>
                                                        <a href="category.php?q=T-Shirts">T-shirts</a>
                                                    </li>
                                                    <li>
                                                        <a href="category.php?q=Shirts">Shirts</a>
                                                    </li>
                                                    <li>
                                                        <a href="category.php?q=Pants">Pants</a>
                                                    </li>
                                                    <li>
                                                        <a href="category.php?q=Accessories">Accessories</a>
                                                    </li>
                                                </ul>
                                            </div>
                                            <div class="col-sm-3">
                                                ...
                                                <ul>
                                                    <li>
                                                        <a href="category.php?q=Trainers">Trainers</a>
                                                    </li>
                                                    <li>
                                                        <a href="category.php?q=Sandals">Sandals</a>
                                                    </li>
                                                    <li>
                                                        <a href="category.php?q=Hiking">Hiking shoes</a>
                                                    </li>
                                                    <li>
                                                        <a href="category.php?q=Casual">Casual</a>
                                                    </li>
                                                </ul>
                                            </div>
                                            <div class="col-sm-3">
                                    ...
                                    <div class="yamm-content">
                                        <div class="row">
                                            <div class="col-sm-3">
                                                ...
                                                <ul>
                                                    <li>
                                                        <a href="category.php?q=T">T-shirts</a>
                                                    </li>
                                                    <li>
                                                        <a href="category.php?q=Shirts">Shirts</a>
                                                    </li>
                                        ...
                                        <div class="row">
                                            <div class="col-sm-3">
                                                ...
                                                <ul>
                                                    ...
                                                    <li>
                                                        <a href="category.php?q=Category">Category - sidebar left</a>
                                                    </li>
                                                    <li>
